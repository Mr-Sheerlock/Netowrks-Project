...
void CustomMsg::copy(const CustomMsg& other)
{
    ...
    this->M_FrameType = other.M_FrameType;
    this->M_Ack = other.M_Ack;
}
...
void CustomMsg::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->M_FrameType);
    doParsimPacking(b,this->M_Ack);
}
...
void CustomMsg::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->M_FrameType);
    doParsimUnpacking(b,this->M_Ack);
}

int CustomMsg::getM_Header() const
{
    return this->M_Header;
}

void CustomMsg::setM_Header(int M_Header)
{
...
char CustomMsg::getM_Trailer() const
{
    return this->M_Trailer;
}

void CustomMsg::setM_Trailer(char M_Trailer)
{
    this->M_Trailer = M_Trailer;
}

int CustomMsg::getM_FrameType() const
{
    return this->M_FrameType;
}

void CustomMsg::setM_FrameType(int M_FrameType)
{
    this->M_FrameType = M_FrameType;
}

int CustomMsg::getM_Ack() const
{
    return this->M_Ack;
}

void CustomMsg::setM_Ack(int M_Ack)
{
    this->M_Ack = M_Ack;
}
...
int CustomMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='M' && strcmp(fieldName, "M_Payload")==0) return base+1;
    if (fieldName[0]=='M' && strcmp(fieldName, "M_Trailer")==0) return base+2;
    if (fieldName[0]=='M' && strcmp(fieldName, "M_FrameType")==0) return base+3;
    if (fieldName[0]=='M' && strcmp(fieldName, "M_Ack")==0) return base+4;
...
std::string CustomMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return long2string(pp->getM_FrameType());
        case 4: return long2string(pp->getM_Ack());
        default: return "";
    }
}
...
bool CustomMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setM_Payload((value)); return true;
        case 2: pp->setM_Trailer(string2long(value)); return true;
        case 3: pp->setM_FrameType(string2long(value)); return true;
        case 4: pp->setM_Ack(string2long(value)); return true;
